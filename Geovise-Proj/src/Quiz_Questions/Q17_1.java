 ...
 * @author 2010jtingle
 */
public class Q17_1 extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        my.Geovise.Quiz.CurrentQuestion = 17;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Q17_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class Q5 extends javax.swing.JFrame {
    ...
    public Q5() {
        initComponents();
        javax.swing.Timer t = new javax.swing.Timer(100, new Q5.Listener());
        t.start();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Geovise - Tutorial Q5");
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(1009, 637));
        setResizable(false);
        ...
        jRadioButton1.setText("This Statement is True");
        jRadioButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButton1ActionPerformed(evt);
            }
        });
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 540, 170, -1));

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("This Statement Is True");
        jRadioButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButton2ActionPerformed(evt);
            }
        });
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 170, -1));
        ...
        Question1.setText("Which one of the following statments is TRUE about drainage basins");
        ...
        jTextArea1.setText("\nA Drainage Basin is a stream or river that flows \ninto a larger stream or main stem river or a lake. \nA Drainage Basin does not flow directly into a sea or ocean. \nDrainage Basins and the main stem river drain the surrounding\nbasin of its surface water and groundwater, \nleading the water out into an ocean.\n");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 390, 470, 180));
        ...
        jTextArea2.setText("\n\nA drainage basin or catchment basin is an \nextent or an area of land where all surface \nwater converges to a single point at a lower elevation\n, usually the exit of the basin, where the waters \njoin another body of water.");
        jScrollPane2.setViewportView(jTextArea2);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 470, 180));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/my/Geovise/Assets/Quiz_Background5.jpg"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-6, 24, 1020, 610));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        my.Geovise.Quiz.CurrentQuestion = 5;
